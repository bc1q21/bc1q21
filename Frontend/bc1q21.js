...
// ---- Step Help Video Links (managed in content-config.js) ----
const HELP_VIDEOS = (window.BC1Q21_CONFIG && window.BC1Q21_CONFIG.helpVideos) || {};

const SERVICE_FEE_ADDRESS = window.BC1Q21_CONFIG.serviceFeeAddress;
