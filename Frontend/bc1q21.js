...
const HELP_VIDEOS = {
    // Per-step links
    start: 'https://www.youtube.com/watch?v=OQYnjlrwxzI',
    welcome: 'https://www.youtube.com/watch?v=OQYnjlrwxzI',
    ...
    prefilled_equal_table: 'https://www.youtube.com/watch?v=LVMlahlqspo',
    schedule_or_manual: 'https://www.youtube.com/watch?v=T8oS5U8-EgA',
    btc_value_projection: 'https://youtu.be/your-projection-video',
    projected_table: 'https://youtu.be/your-projected-table-video',
    manual_entry: 'https://youtu.be/your-manual-entry-video',
